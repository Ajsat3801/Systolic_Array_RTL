...
# Read all Verilog files from file list
read_verilog ./designs/src/SystolicArray/Accumulator.v
read_verilog ./designs/src/SystolicArray/Banked_Buffer.v
read_verilog ./designs/src/SystolicArray/bfp16_mult.v
read_verilog ./designs/src/SystolicArray/bfp32_adder.v
read_verilog ./designs/src/SystolicArray/Buffer.v
read_verilog ./designs/src/SystolicArray/Controller.v
read_verilog ./designs/src/SystolicArray/Individual_Buffer.v
read_verilog ./designs/src/SystolicArray/Instruction_buffer.v
read_verilog ./designs/src/SystolicArray/MAC.v
#read_verilog ./designs/src/SystolicArray/Main.v
read_verilog ./designs/src/SystolicArray/Output_Buffer.v
read_verilog ./designs/src/SystolicArray/PE.v

# Check the hierarchy with the correct top module
hierarchy -check -top $::env(DESIGN_NAME)

# Set ungroup threshold
set ungroup_threshold 0
if { $::env(MAX_UNGROUP_SIZE) > 0 } {
    set ungroup_threshold $::env(MAX_UNGROUP_SIZE)
    puts "Ungrouping modules of size greater than $ungroup_threshold"
}

# Ungroup modules or keep hierarchy
...
# Synthesize with hierarchy enabled
synth -top ${DESIGN_NAME} -flatten none

# Check synthesized netlist
synthesize_check mem s::env(SYNTH_FULL_ARGS)

# Optional: Clean up unnecessary cells
